...
namespace pppl_uml_python
{
    ...
    {
        public static bool Point11(Translate form1, JArray subsystems)
        {
        ...
        public static bool Point13(Translate form1, JArray jsonArray)
        {
            TextBox msgBox = form1.GetMessageBox();
        ...
        public static bool Point14(Translate form1, JArray subsystems)
        {
            TextBox msgBox = form1.GetMessageBox();
            try
            {
        ...
        public static bool Point15(Translate form1, JArray subsystems)
        {
            TextBox msgBox = form1.GetMessageBox();
            try
            {
        ...
        public static bool Point99(Translate form1, JArray subsystems)
        {
            TextBox msgBox = form1.GetMessageBox();
            try
            {
