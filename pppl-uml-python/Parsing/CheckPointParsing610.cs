...
namespace pppl_uml_python
{
    ...
    {
        public static bool Point6(Translate form1, JArray jsonArray)
        {
        ...
        public static bool Point7(Translate form1, JArray jsonArray)
        {
            TextBox msgBox = form1.GetMessageBox();
            try
            {
        ...
        public static bool Point8(Translate form1, JArray jsonArray)
        {
            TextBox msgBox = form1.GetMessageBox();
            try
            {
        ...
        public static bool Point9(Translate form1, JArray jsonArray)
        {
            TextBox msgBox = form1.GetMessageBox();
            try
            {
        ...
        public static bool Point10(Translate form1, JArray jsonArray)
        {
            TextBox msgBox = form1.GetMessageBox();
