...
namespace pppl_uml_python
{
    ...
    {
        public static bool Point1(Translate form1, JArray jsonArray)
        {
        ...
        public static bool Point2(Translate form1, JArray jsonArray)
        {
        ...
        public static bool Point3(Translate form1, JArray jsonArray)
        {
        ...
        public static bool Point4(Translate form1, JArray jsonArray)
        {
            TextBox msgBox = form1.GetMessageBox();
            try
            {
        ...
        public static bool Point5(Translate form1, JArray jsonArray)
        {
            TextBox msgBox = form1.GetMessageBox();
            try
            {
